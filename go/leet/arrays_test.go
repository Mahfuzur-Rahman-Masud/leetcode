...
func BenchmarkFindRelativeRanks(t *testing.B) {
...
func BenchmarkFindPoisonedDuration(t *testing.B) {
	assert.Equal(t, 4, findPoisonedDuration([]int{1, 4}, 2))
	assert.Equal(t, 3, findPoisonedDuration([]int{1, 2}, 2))
}

func BenchmarkConstructRectangle2(t *testing.B) {
	assert.Equal(t, []int{2, 2}, constructRectangle2(4))
	assert.Equal(t, []int{3, 3}, constructRectangle2(9))
	assert.Equal(t, []int{37, 1}, constructRectangle2(37))
	assert.Equal(t, []int{13, 1}, constructRectangle2(13))
	assert.Equal(t, []int{13, 3}, constructRectangle2(39))
	assert.Equal(t, []int{4, 3}, constructRectangle2(12))
	assert.Equal(t, []int{6, 3}, constructRectangle2(18))
	assert.Equal(t, []int{54833, 28}, constructRectangle2(1535324))
}

func BenchmarkConstructRectangle(t *testing.B) {
	assert.Equal(t, []int{2, 2}, constructRectangle(4))
	assert.Equal(t, []int{3, 3}, constructRectangle(9))
	assert.Equal(t, []int{37, 1}, constructRectangle(37))
	assert.Equal(t, []int{13, 1}, constructRectangle(13))
	assert.Equal(t, []int{13, 3}, constructRectangle(39))
	assert.Equal(t, []int{4, 3}, constructRectangle(12))
	assert.Equal(t, []int{6, 3}, constructRectangle(18))
	assert.Equal(t, []int{54833, 28}, constructRectangle(1535324))

}

func BenchmarkFindMedianOfSortedArrays(t *testing.B) {
	assert.Equal(t, float64(2), findMedianSortedArrays([]int{1, 3}, []int{2}))
	assert.Equal(t, 2.5, findMedianSortedArrays([]int{1, 3}, []int{2, 4}))
	assert.Equal(t, float64(2), findMedianSortedArrays([]int{1, 2, 3}, []int{2, 4}))
	assert.Equal(t, float64(1.5), findMedianSortedArrays([]int{1, 2}, []int{}))
	assert.Equal(t, float64(-1), findMedianSortedArrays([]int{}, []int{}))
	assert.Equal(t, float64(1), findMedianSortedArrays([]int{1}, []int{}))
	assert.Equal(t, float64(2), findMedianSortedArrays([]int{}, []int{2}))
	...
	assert.Equal(t, float64(2.5), findMedianSortedArrays([]int{3, 7}, []int{1, 2}))
	assert.Equal(t, float64(5), findMedianSortedArrays([]int{3, 7}, []int{1, 10}))

}

func BenchmarkIslandPerimeter(t *testing.B) {
...
func BenchmarkIslandPerimeter2(t *testing.B) {
	grid := [][]int{{0, 1, 0, 0}, {1, 1, 1, 0}, {0, 1, 0, 0}, {1, 1, 0, 0}}
	assert.Equal(t, 16, islandPerimeter2(grid))
	assert.Equal(t, 4, islandPerimeter2([][]int{{1, 0}}))
	assert.Equal(t, 4, islandPerimeter2([][]int{{1}}))
}

func BenchmarkFindContentChildren(t *testing.B) {
	assert.Equal(t, 1, findContentChildren([]int{1, 2, 3}, []int{1, 1}))
	assert.Equal(t, 2, findContentChildren([]int{1, 2}, []int{1, 2, 3}))
	assert.Equal(t, 1, findContentChildren([]int{1, 2}, []int{1, 1, 1}))
	assert.Equal(t, 2, findContentChildren([]int{1, 2, 1}, []int{1, 1, 1}))

	Init()
	assert.Equal(t, caps, findContentChildren(g, s))
}

func BenchmarkFindContentChildrenBruteForce(t *testing.B) {
	assert.Equal(t, 1, findContentChildrenBruteForce([]int{1, 2, 3}, []int{1, 1}))
	assert.Equal(t, 2, findContentChildrenBruteForce([]int{1, 2}, []int{1, 2, 3}))
	assert.Equal(t, 1, findContentChildrenBruteForce([]int{1, 2}, []int{1, 1, 1}))
	assert.Equal(t, 2, findContentChildrenBruteForce([]int{1, 2, 1}, []int{1, 1, 1}))
	assert.Equal(t, 2, findContentChildrenBruteForce([]int{1, 2, 1}, []int{1, 1, 1}))

	Init()
	assert.Equal(t, caps, findContentChildrenBruteForce(g, s))
}
...
func TestFindDisappearedNumbers(t *testing.T) {
	...
	assert.Equal(t, []int{1}, findDisappearedNumbers([]int{2, 2}))
	assert.Equal(t, []int{1, 6, 7, 8}, findDisappearedNumbers([]int{2, 2, 3, 4, 5, 5, 5, 5}))
}

func BenchmarkFindDisappearedNumbers(t *testing.B) {
	assert.Equal(t, []int{5, 6}, findDisappearedNumbers([]int{4, 3, 2, 7, 8, 2, 3, 1}))
	assert.Equal(t, []int{2}, findDisappearedNumbers([]int{1, 1}))
	assert.Equal(t, []int{1}, findDisappearedNumbers([]int{2, 2}))
	assert.Equal(t, []int{1, 6, 7, 8}, findDisappearedNumbers([]int{2, 2, 3, 4, 5, 5, 5, 5}))
...
func BenchmarkFindDisappearedNumbers2(t *testing.B) {
	assert.Equal(t, []int{5, 6}, findDisappearedNumbers2([]int{4, 3, 2, 7, 8, 2, 3, 1}))
	assert.Equal(t, []int{2}, findDisappearedNumbers2([]int{1, 1}))
	assert.Equal(t, []int{1}, findDisappearedNumbers2([]int{2, 2}))
	assert.Equal(t, []int{1, 6, 7, 8}, findDisappearedNumbers2([]int{2, 2, 3, 4, 5, 5, 5, 5}))
}

func TestIntersectAll(t *testing.T) {
	assert.Equal(t, []int{2, 2}, intersect_all([]int{1, 2, 2, 1}, []int{2, 2}))
	assert.Equal(t, []int{9, 4}, intersect_all([]int{4, 9, 5}, []int{9, 4, 9, 8, 4}))
}
...
func TestSumRange(t *testing.T) {
	n := Constructor2([]int{0})
	assert.Equal(t, 0, (&n).SumRange(0, 0))

	n = Constructor2([]int{-2, 0, 3, -5, 2, -1})
	assert.Equal(t, -2, (&n).SumRange(0, 0))
	assert.Equal(t, -2, (&n).SumRange(0, 1))
	assert.Equal(t, 1, (&n).SumRange(0, 2))
	assert.Equal(t, 3, (&n).SumRange(2, 2))
	assert.Equal(t, 3, (&n).SumRange(1, 2))
	assert.Equal(t, -2, (&n).SumRange(2, 3))
	assert.Equal(t, -3, (&n).SumRange(3, 4))
	assert.Equal(t, 0, (&n).SumRange(2, 4))
